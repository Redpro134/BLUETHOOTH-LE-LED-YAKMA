...
void loop() {
  ...
  if (veri == 'B') { //Seri haberleşmeden k harfi geldiğinde bu kısım çalışır.
    digitalWrite(kirmiziPin, LOW);
    digitalWrite(yesilPin, HIGH);
    digitalWrite(maviPin, LOW);
  } else if (veri == 'P') { //Seri haberleşmeden y harfi geldiğinde bu kısım çalışır.
    digitalWrite(kirmiziPin, LOW);
  ...
  } else if (veri == 'K') { //Seri haberleşmeden a harfi geldiğinde bu kısım çalışır.
    digitalWrite(kirmiziPin, LOW);
    digitalWrite(yesilPin, LOW);
    digitalWrite(maviPin, LOW);
